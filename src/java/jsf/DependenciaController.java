...
public class DependenciaController implements Serializable {
    ...
    @EJB
    private ejb.DependenciaFacade ejbFacade;
    ...
    public Dependencia getDependencia(java.lang.Long id) {
    ...
    public static class DependenciaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getDependencia(getKey(value));
        }
